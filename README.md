...
docs/
  ...
  context/              # Persistent project context knowledge base (5 files)
...
A: Five files in `docs/context/` that capture deep project knowledge (overview, tech stack, patterns, structure, product domain). Generated by `/bootstrap`, incrementally updated by `/sprint-end`, and loaded by `/continue`. Unlike session handoffs which capture what happened, context files capture what the project IS — and this knowledge compounds across sessions.
