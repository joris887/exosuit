...
| `/story-cycle` | Universal story delivery with confidence gate, risk-calibrated planning, intent-based security, adaptive depth, TDD, wave execution, parallel streams, error learning, failure state persistence, and verification |
...
- **Data-driven** — Adaptive depth calibration from historical data, rule health analysis, skill regression detection, cross-session error learning
