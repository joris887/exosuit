...
flowchart TD
  ...
  n_fix_auth_check{"fix auth check"}
  ...
  n_redact_findings["redact findings"]
  ...
  n_preflight_gate -->|approval-needed| n_cmd_approval
  n_preflight_gate -->|degraded-accepted| n_seed_offer
  n_offer_remediation --> n_run_preflight
  n_cmd_approval -->|ok| n_run_preflight
  n_cmd_approval -->|declined| n_offer_remediation
  ...
  n_classify_failures -->|bug-critical| n_fix_auth_check
  ...
  n_fix_auth_check -->|fix-flag| n_fix_investigate
  n_fix_auth_check -->|default| n_log_finding
  ...
  n_uat_update_check -->|default| n_redact_findings
  n_append_uat_rows --> n_redact_findings
  n_redact_findings --> n_commit_findings
...
| n_uat_update_check | uat-cases-executed | n_append_uat_rows |
| n_uat_update_check | default | n_redact_findings |
| n_append_uat_rows | next | n_redact_findings |
| n_redact_findings | next | n_commit_findings |
