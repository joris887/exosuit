...
Each subdirectory is a skill. `SKILL.md` is the entry point.

## Canonical format:
- YAML frontmatter: name, version, description, trigger, depends-on, references, plus operational attributes
